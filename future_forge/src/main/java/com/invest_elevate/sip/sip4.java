...
public class sip4 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        ImageView sipImageView = new ImageView(new Image("file:future_forge//src//main//resources//images//it.jpeg"));
        sipImageView.setFitHeight(100);
        sipImageView.setFitWidth(100);
        Label sipTitle = new Label("IT Sector");
        ...
        Label name = new Label("Name: IT Sector ");
        Label aum = new Label("AUM: 2200 CR");
        Label numStocks = new Label("No. of Stocks Included: 10");
        Label founded = new Label("Founded in: 2017");
        ...
        Label expenseRatio = new Label("Expense Ratio: 0.27%");
        Label nav = new Label("NAV: RS 227");
        ...
        Label chance = new Label("Chance: This fund has generated a 32.27% annual return in 125% of times for investors holding for at least 5 years.");
        ...
        Label returnRisk = new Label("Return/Risk: The fund is performing goog than its category.");
        ...
        Label threeYearReturn = new Label("3 years: 59%");
        Label fiveYearReturn = new Label("5 years: 95%");
        ...
        series.getData().add(new XYChart.Data<>(3, 64));
        series.getData().add(new XYChart.Data<>(4, 79));
        ...
        stocksPieChart.getData().addAll(
                new PieChart.Data("Tata Consultancy Service (48.07%)", 48.07),
                new PieChart.Data("Infosys (20.54%)", 20.54),
                new PieChart.Data("HCL Technologies (13.80%)", 13.80),
                new PieChart.Data("Wipro Limited (8.06%)", 8.06),
                new PieChart.Data("LTIMindtree Ltd. (4.79%)", 4.79),
                new PieChart.Data("Tech Mahindra Ltd. (4.01%)", 4.01),
                new PieChart.Data("Oracle Fin Serv (0.24%)", 0.24),
                new PieChart.Data("Persistent  (0.20%)", 0.20),
                new PieChart.Data("MphasiS Ltd. (0.15%)", 0.15),
                new PieChart.Data("KPIT Tech (0.13%)", 0.13)
        );
